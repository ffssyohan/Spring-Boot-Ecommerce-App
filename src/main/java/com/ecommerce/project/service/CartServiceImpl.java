...
public class CartServiceImpl implements CartService {
    ...
    public CartDTO getCart(String emailId, Long cartId) {
        Cart cart = cartRepository.findCartByAndCartId(emailId, cartId);
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
        // retrieving user email to identify logged in user cart
        ...
        // looping through every cart item  and converting to ProductDTO and then setting the correct quantity
        Stream<ProductDTO> productStream = cartItems.stream()
                .map(item -> {ProductDTO prd = modelMapper
                        .map(item.getProduct(), ProductDTO.class);
